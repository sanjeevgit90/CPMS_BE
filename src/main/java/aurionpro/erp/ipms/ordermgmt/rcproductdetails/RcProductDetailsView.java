...
@Immutable
@Entity
@Table(name = "rc_product_details_view", schema = "ordermgmt")
public class RcProductDetailsView {
	...
	public Long getRateContract() {
		return rateContract;
	}

	public void setRateContract(Long rateContract) {
