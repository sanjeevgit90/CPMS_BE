...
@Entity
@Table(name = "rate_contract_history_details", schema = "ordermgmt")
public class RateContractHistoryDetails extends JKDEntityAuditWithId {
	...
	/*@Column(name = "rate_contract_id", length = 36, unique = true)
	private String rateContractId;*/
	
	@OneToOne()
    @JoinColumn(name="rate_contract_id", unique = true)
	private RateContractMaster rateContractMaster;
	...
	public RateContractMaster getRateContractMaster() {
		return rateContractMaster;
	}

	public void setRateContractMaster(RateContractMaster rateContractMaster) {
		this.rateContractMaster = rateContractMaster;
	}
