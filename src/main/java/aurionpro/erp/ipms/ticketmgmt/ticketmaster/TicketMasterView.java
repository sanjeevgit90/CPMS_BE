...
@Entity
@Table(name = "ticketmaster_view" ,schema = "ticketmgmt")
@JsonIgnoreProperties
public class TicketMasterView {
	...
	private String totalCloserTime;
	...
	public String getTotalCloserTime() {
		return totalCloserTime;
	}

	public void setTotalCloserTime(String totalCloserTime) {
		this.totalCloserTime = totalCloserTime;
	}
