...
public class BusinessDetailsDTO {
	...
	public String getAvgMonthlyTxns() {
		return avgMonthlyTxns;
	}
	public void setAvgMonthlyTxns(String avgMonthlyTxns) {
		this.avgMonthlyTxns = avgMonthlyTxns;
	}
	...
	public String getCurrencyAcceptance() {
		return currencyAcceptance;
	}
	public void setCurrencyAcceptance(String currencyAcceptance) {
		this.currencyAcceptance = currencyAcceptance;
	}
